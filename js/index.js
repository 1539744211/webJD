(function() {
    ...
    $($("#slider ul:last-child").children()[0]).css("background",'white');
    //倒计时的时间
    var times = 9 * 60 * 60;
    ...
    window.mySwipe = new Swipe(document.getElementById('slider'), {
        ...
        // stopPropagation: false,
         callback: function(index, elem) {
             ...
             $($("#slider ul:last-child").children()[index]).css("backgroundColor","white");
             $($("#slider ul:last-child").children()[index]).siblings().css("backgroundColor","");
         },
